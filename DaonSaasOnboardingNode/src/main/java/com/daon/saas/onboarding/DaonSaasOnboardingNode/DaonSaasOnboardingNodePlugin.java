 ...
 * @since AM 5.5.0
 */
public class DaonSaasOnboardingNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(DaonSaasOnboardingNodePlugin.currentVersion, 
				Collections.singletonList(DaonSaasOnboardingNode.class));
	}
	...
	public String getPluginVersion() {
		return DaonSaasOnboardingNodePlugin.currentVersion;
	}
}
